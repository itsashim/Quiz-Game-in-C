...
int main()
    ...
    printf("\n    By this way you can win upto 2.3 MILLION cash prize!!!!!..........");
...
game:
	...
	if(score>0.00 && score<2300000)
	{
	   printf("\n\n\t\t**************** CONGRATULATION *****************");
	     printf("\n\t You won $%.2f",score);goto go;}

	 else if(score==2300000.00)
	{
	    printf("\n\n\n \t\t**************** CONGRATULATION ****************");
	    printf("\n\t\t\t\t YOU ARE A MILLIONAIRE YOU WIN 2.3 MIL!!!!!!!!!");
	    printf("\n\t\t You won $%.2f",score);
	    printf("\t\t Thank You!!");
	}
	 else
...
void help()
    ...
    printf("\n    total 23 questions each right answer will be awarded $100,000.");
    printf("\n    By this way you can win upto ONE MILLION cash prize in USD...............");
    printf("\n >> You will be given 4 options and you have to press A, B ,C or D for the");
    printf("\n    right option");
    printf("\n >> You will be asked questions continuously if you keep giving the right answers.");
    printf("\n >> You will be eliminated immediately if you answer incorrectly");
    // printf("\n >> ");

	printf("\n\n\t*********************BEST OF LUCK*********************************");
	// printf("\n\n\t*****C PROGRAM QUIZ GAME is developed by KAUSHAL RAJ TRITAL********");
	}
